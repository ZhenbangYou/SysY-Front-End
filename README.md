...
Finding either the documentation or code obscure or unintelligible, please contact me or just blame in github. I will keep updating this documentation (for the latest version, see [here](https://github.com/ZhenbangYou/SysY-Front-End)). The success of this project relies on the readability to a large extent.  
